...
void setup() {
    ...
    motA.attach(servo_pin1, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    motB.attach(servo_pin2, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    motC.attach(servo_pin3, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    motD.attach(servo_pin4, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
